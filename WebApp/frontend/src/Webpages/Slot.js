...
export default class Slot extends React.Component {
    ...
    showslotdetails = (e) => {
        let cq = "?slot="+this.state.slot
        fetch('http://localhost:5000/slotdetails/'+cq, {
            method: 'GET',
            dataType: 'json'
          })
            .then(res => res.json())
    ...
    render() {
        ...
        <div className="search_div">
            ...
            <br/><Button onClick={this.showslotdetails}> Search </Button> <br/>
            <span>{this.state.error}</span>
            <Query results={this.state.slots} urlpath={this.state.urlpath} hyperlink={false}/>
